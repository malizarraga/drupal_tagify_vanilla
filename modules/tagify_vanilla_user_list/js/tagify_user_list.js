...
(function (Drupal, drupalSettings, Sortable) {
  Drupal.behaviors.tagifyAutocompleteUserList = {
    attach: function attach() {
      ...
      const elements = once('tagify-user-list-widget', 'input.tagify-user-list-widget');
  ...
  Drupal.behaviors.nodeDetailsSummaries = {
    attach: function attach(context) {
      ...
      context.querySelector('.node-form-author').drupalSetSummary(function (context) {
        const authorInput = context.querySelector('.field--name-uid input');
        const createdInput = context.querySelector('.field--name-created input');
